...
var _PromiseRouter2 = _interopRequireDefault2(_PromiseRouter);

var _rest = require('../rest');

var _rest2 = _interopRequireDefault2(_rest);

var _AdaptableController2 = require('./AdaptableController');

var _AdaptableController3 = _interopRequireDefault2(_AdaptableController2);

var _PushAdapter = require('../Adapters/Push/PushAdapter');

var _deepcopy = require('deepcopy');

var _deepcopy2 = _interopRequireDefault2(_deepcopy);

var _RestQuery = require('../RestQuery');

var _RestQuery2 = _interopRequireDefault2(_RestQuery);

var _RestWrite = require('../RestWrite');

var _RestWrite2 = _interopRequireDefault2(_RestWrite);

var _Auth = require('../Auth');

var _pushStatusHandler = require('../pushStatusHandler');

var _pushStatusHandler2 = _interopRequireDefault2(_pushStatusHandler);
  ...
  _createClass(PushController, [{
    ...
    value: function sendPush() {
      ...
      return Promise.resolve().then(function () {
        ...
        /** Debug Logging AP **/
        _npmlog2.default.info('pushcontroller >> sendPush >>', results.map(function (a) {
          return a.device.deviceToken + ' - ' + a.transmitted;
        }));
        /*********************/
