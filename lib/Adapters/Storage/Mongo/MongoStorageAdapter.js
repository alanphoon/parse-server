...
var MongoStorageAdapter = exports.MongoStorageAdapter = function () {
  ...
  _createClass(MongoStorageAdapter, [{
    ...
    value: function createObject(className, object, schema) {
      var mongoObject = transform.parseObjectToMongoObject(schema, className, object);
      return this.adaptiveCollection(className).then(function (collection) {
    ...
    value: function deleteObjectsByQuery(className, query, schemaController, validate) {
      return this.adaptiveCollection(className).then(function (collection) {
        var mongoWhere = transform.transformWhere(schemaController, className, query, { validate: validate });
