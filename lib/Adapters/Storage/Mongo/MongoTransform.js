...
function transformAtom(atom, force) {
  ...
  var inArray = _ref2.inArray;
  var inObject = _ref2.inObject;
...
function addWriteACL(mongoWhere, acl) {
  return { '$and': [mongoWhere, { "_wperm": { "$in": [null].concat(_toConsumableArray(acl)) } }] };
}

function addReadACL(mongoWhere, acl) {
  return { '$and': [mongoWhere, { "_rperm": { "$in": [null, "*"].concat(_toConsumableArray(acl)) } }] };
}
