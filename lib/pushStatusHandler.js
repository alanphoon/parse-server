...
function pushStatusHandler(config) {
  ...
  var setRunning = function setRunning(installations) {
    ...
    return database.update(PUSH_STATUS_COLLECTION, { status: "pending", objectId: objectId }, { status: "running" });
  };
  ...
  var complete = function complete(results) {
    ...
    return database.update('_PushStatus', { status: "running", objectId: objectId }, update);
  };
  ...
  var fail = function fail(err) {
    ...
    return database.update('_PushStatus', { objectId: objectId }, update);
  };
